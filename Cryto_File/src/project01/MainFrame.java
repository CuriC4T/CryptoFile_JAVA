...
public class MainFrame extends JFrame {
	...
	public void init() {
		...
		TwoFish = new JRadioButton("Two_Fish");
	...
	public void setEvent() {
		bt1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				//String temp=filemanagemet.readAllBytes("C:\\Users\\hjwja\\asd.jar");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(new File(filenameField.getText()).exists()&&outputFileName!=null&&password!=null) {
					if (AES.isSelected()) {
						...
						temp=filemanagemet.readAllBytes(filenameField.getText());
						try {
							encryptedByte=aes.encrypt(temp);
						...
						filemanagemet.saveFile(outputField.getText(), encryptedByte);
			...
			public void actionPerformed(ActionEvent e) {
				...
				if(new File(filenameField.getText()).exists()&&outputFileName!=null&&password!=null) {
					if (AES.isSelected()) {
						...
						temp=filemanagemet.readAllBytes(filenameField.getText());
						try {
							encryptedByte=aes.decrypt(temp);
						} catch (NoSuchAlgorithmException e1) {
							// TODO Auto-generated catch block
							e1.printStackTrace();
						} catch (UnsupportedEncodingException e1) {
